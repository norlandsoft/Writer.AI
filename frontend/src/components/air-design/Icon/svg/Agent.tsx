  ...
  return (
    <svg width={props.size} height={props.size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M21.5 8H2.5" stroke={props.color} strokeWidth={props.thickness} strokeLinecap="round"></path>
        <path d="M10.5 2.5L7 8" stroke={props.color} strokeWidth={props.thickness} strokeLinecap="round"></path>
        <path d="M17 2.5L13.5 8" stroke={props.color} strokeWidth={props.thickness} strokeLinecap="round"></path>
        <path
