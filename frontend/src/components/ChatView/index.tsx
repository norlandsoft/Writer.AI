...
import rehypeKatex from 'rehype-katex'; // 渲染数学公式为html
...
const ChatView: React.FC<ChatViewProps> = (props: ChatViewProps) => {
  ...
  return (
    <div className={styles.message} style={{height: height}} id={'message_panel'} ref={messagesEndRef}
            ...
            <div className={styles.item} key={message.id}>
              <div className={styles.title} style={message.type === 'q' ? userTitle : respTitle}>
                <div className={styles.avatar}>
                  <Icon size={24} name={message.type === 'q' ? 'talker' : 'flash'}/>
                </div>
          ...
          <div className={styles.item}>
            ...
            </div>
            {
              lastResponse.length === 0 && (
                <div style={respStyle}>
                  <Spin size={"default"} style={{margin: '11px 0'}}/>
                </div>
              )
            }
